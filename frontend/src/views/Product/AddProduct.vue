    ...
    <div class="container">
      <div class="row mb-4">
        <div class="col-12 text-start">
          ...
          <h2 class="text-white font-weight-bold mb-1">List New Hardware</h2>
          <p class="text-muted small">Register a new graphics card, processor, or storage kit in the marketplace directory.</p>
        </div>
      </div>
              ...
              <div class="row g-3">
                <div class="col-12">
                  ...
                  <input 
                    ...
                    placeholder="e.g. NVIDIA GeForce RTX 4080 Founders Edition"
                    required
                  />
                ...
                <div class="col-12">
                  ...
                  <textarea 
                    ...
                    placeholder="Detail hardware specs, memory clock speed, ray-tracing limits..."
                    required
                  ></textarea>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label text-white small" for="srcUrl">URL Link</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" id="srcUpload" value="upload" v-model="imageSource">
                    <label class="form-check-label text-white small" for="srcUpload">Upload Local File</label>
                  </div>
                </div>
  ...
  methods: {
    ...
    async fetchStoreId() {
      ...
      try {
        ...
        console.warn('Could not load seller store during product adding:', err);
      }
    },
